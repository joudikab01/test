            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () {
                      String token = Provider.of<ProductsManager>(context,listen: false).getToken();
                      var box = Boxes.getUserBox();
                      UserSign? user = box.get('userData');
                      int id = user!.id;
                     Provider.of<ProductsManager>(context,listen: false).deleteAccount('Bearer $token', id);
                     var box2 = Boxes.getAuthBox();
                     box2.clear();
                     Navigator.popAndPushNamed(context, '/splash_screen');
                    },
                    child: Padding(
                      ...
                      child: Text(
                        isEng ? 'Delete Account' : 'حذف الحساب',
                        style: TextStyle(
